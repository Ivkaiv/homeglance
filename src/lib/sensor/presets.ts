...
export const SENSOR_PRESETS: Record<Exclude<SensorType, 'auto' | 'numeric'>, SensorPreset> = {
  ...
  door: {
    ...
    binary: {
      onIcon: 'door-open',
      onLabel: 'sensor.door.open',
      offLabel: 'sensor.door.closed',
  ...
  window: {
    ...
    binary: {
      ...
      onLabel: 'sensor.window.open',
      offLabel: 'sensor.window.closed',
      onAccent: 'text-amber-600 dark:text-amber-300',
    },
  },
  motion: {
    ...
    binary: {
      onIcon: 'walk',
      onLabel: 'sensor.motion.on',
      offLabel: 'sensor.motion.off',
  ...
  occupancy: {
    ...
    binary: {
      onIcon: 'account',
      onLabel: 'sensor.occupancy.on',
      offLabel: 'sensor.occupancy.off',
      onAccent: 'text-emerald-600 dark:text-emerald-300',
    },
  },
  plug: {
    ...
    binary: {
      onIcon: 'power-plug',
      onLabel: 'sensor.plug.on',
      offLabel: 'sensor.plug.off',
      onAccent: 'text-emerald-600 dark:text-emerald-300',
    },
  },
};
